...
const SelectTaskPriority = ({ taskPriority, setTaskPriority }) => {
    return (
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-body" >
                        ...
                        <Form.Select size="sm" className='my-4' onChange={(e) => setTaskPriority(e.target.value)}>
                    ...
                    <div className="modal-footer">
                        <button className="btn btn-secondary" data-bs-target="#inputTaskTypeModal" data-bs-toggle="modal">Back</button>
